...
public class PrefabsDir
{
    //Put all the Prefabs directions here
	public static string coinDir = "Prefabs/Items/Coin";
	public static string arrowDir = "Prefabs/Items/Arrow";
	...
	public static string uiDeathDir = "Prefabs/UI/GameOverUI";
